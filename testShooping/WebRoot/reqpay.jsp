...
<%
	...
	String keyValue = formatString(ConfigInfo.getVlaue("keyValue")); // 商家密钥
		System.out.println(keyValue);	
	String nodeAuthorizationURL = formatString(ConfigInfo.getVlaue("backUrl")); // 交易请求地址
	// 商家设置用户购买商品的支付信息
	String p0_Cmd = formatString("Buy"); // 在线支付请求，固定值 ”Buy”
	String p1_MerId = formatString(ConfigInfo.getVlaue("p1_MerId")); // 商户编号
	...
	String pr_NeedResponse = formatString("0"); // 默认为"1"，需要应答机制,反之
