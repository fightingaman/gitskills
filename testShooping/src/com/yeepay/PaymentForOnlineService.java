...
public class PaymentForOnlineService {
	...
	private static String p1_MerId 			= ConfigInfo.getVlaue("p1_MerId"); 			// 商家ID
	private static String queryRefundReqURL = ConfigInfo.getVlaue("backUrl");	// 请求地址
	private static String keyValue 			= ConfigInfo.getVlaue("keyValue");				// 商家密钥
